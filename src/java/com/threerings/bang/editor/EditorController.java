    ...
    implements PieceCodes
{
    ...
    /** Instructs us to bring up the grid color dialog. */
    public static final String CHANGE_GRID_COLOR = "ChangeGridColor";
    ...
    /** Handles a request to change the grid color.  Generated by
     * the {@link #CHANGE_GRID_COLOR} command. */
    public void handleChangeGridColor (Object source)
    {
        ColorRGBA gcolor = _panel.view.getGridColor();
        Color color = JColorChooser.showDialog(_panel,
            _msgs.get("t.grid_color"),
            new Color(gcolor.r, gcolor.g, gcolor.b));
        if (color != null) {
            float[] ccomps = color.getRGBColorComponents(null);
            _panel.view.setGridColor(new ColorRGBA(
                ccomps[0], ccomps[1], ccomps[2], 0.4f));
        }
    }
