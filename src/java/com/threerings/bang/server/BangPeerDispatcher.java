 ...
 */
public class BangPeerDispatcher extends InvocationDispatcher<BangPeerMarshaller>
{
    /**
    ...
    public BangPeerMarshaller createMarshaller ()
    {
