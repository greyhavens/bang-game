        ...
        throws InvocationException
    {
        ...
        case PlayerMarshaller.CREATE_ACCOUNT:
            ((PlayerProvider)provider).createAccount(
                source, (String)args[0], (String)args[1], (String)args[2], (String)args[3], ((Long)args[4]).longValue(), (InvocationService.ConfirmListener)args[5]
            );
            return;
        ...
        case PlayerMarshaller.PICK_FIRST_BIG_SHOT:
            ((PlayerProvider)provider).pickFirstBigShot(
                source, (String)args[0], (Name)args[1], (InvocationService.ConfirmListener)args[2]
            );
            return;
        ...
        case PlayerMarshaller.PLAY_COMPUTER:
            ((PlayerProvider)provider).playComputer(
                source, ((Integer)args[0]).intValue(), (String[])args[1], (String)args[2], ((Boolean)args[3]).booleanValue(), (InvocationService.InvocationListener)args[4]
            );
            return;
        ...
        case PlayerMarshaller.UPDATE_POSTER_INFO:
            ((PlayerProvider)provider).updatePosterInfo(
                source, ((Integer)args[0]).intValue(), (String)args[1], (int[])args[2], (InvocationService.ConfirmListener)args[3]
            );
            return;
