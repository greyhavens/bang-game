    ...
    implements ParlorService
{
    ...
    public static final int START_MATCH_MAKING = 1;
    ...
    public static final int UPDATE_GAME_CONFIG = 2;
    ...
    public static final int UPDATE_PARLOR_CONFIG = 3;
    ...
    public static final int UPDATE_PARLOR_PASSWORD = 4;
