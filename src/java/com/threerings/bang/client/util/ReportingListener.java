...
/**
 * Displays a feedback message to the chat window when the server reports
 * success or failure.
 */
    ...
    implements InvocationService.ConfirmListener
{
     ...
     * @param errwrap the wrapper message for the error report
     */
    public ReportingListener (BangContext ctx, String bundle, String success,
        String errwrap)
    {
        _ctx = ctx;
        _bundle = bundle;
    ...
    {
        _ctx.getChatDirector().displayFeedback(_bundle,
            MessageBundle.compose(_errwrap, cause));
    }
