...
public class ForestGuardians extends Scenario
{
        ...
        ArrayList<Piece> updates)
    {
        ...
        // extract and remove all fetish markers; store the tree beds
        _fetishSpots.clear();
    ...
    public void tick (BangObject bangobj, short tick)
    {
        ...
        if (tick < _nextWaveTick) {
            ...
            switch (_lrdelegate.isWaveOver(bangobj, tick)) {
            case END_WAVE:
    ...
    protected void startNextWave (BangObject bangobj)
    {
        ...
        // notify the delegate
        _lrdelegate.waveStarted(
            bangobj, _wave, _difficulty, _ctrees, _treesGrown);
    }
