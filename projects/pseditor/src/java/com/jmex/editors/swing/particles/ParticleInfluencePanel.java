...
public class ParticleInfluencePanel extends ParticleEditPanel {
    ...
    private void initPanel() {
        ...
        JButton newWanderButton = new JButton(new AbstractAction("New Wander") {
            private static final long serialVersionUID = 1L;
            public void actionPerformed(ActionEvent e) {
                getEdittedParticles().addInfluence(new WanderInfluence());
                int idx = getEdittedParticles().getInfluences().size() - 1;
                influenceModel.fireIntervalAdded(idx, idx);
                influenceList.setSelectedIndex(idx);
            }
        });
        newWanderButton.setMargin(new Insets(2, 2, 2, 2));
        ...
        influenceListPanel.add(newVortexButton, new GridBagConstraints(2, 1, 1, 1,
                0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(5, 5, 5, 5), 0, 0));
        influenceListPanel.add(newSwarmButton, new GridBagConstraints(1, 2, 1, 1,
                0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(5, 5, 5, 5), 0, 0));
        influenceListPanel.add(newWanderButton, new GridBagConstraints(2, 2, 1, 1,
                0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(5, 5, 5, 5), 0, 0));
        influenceListPanel.add(deleteInfluenceButton, new GridBagConstraints(1, 3, 2, 1,
                0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
    ...
    private void updateInfluenceParams() {
        ...
        if (influence instanceof SimpleParticleInfluenceFactory.BasicWind) {
            ...
            wanderInfluencePanel.setEdittedInfluence(influence);
            wanderInfluencePanel.updateWidgets();
            influenceParamsPanel.add(wanderInfluencePanel);
        }
