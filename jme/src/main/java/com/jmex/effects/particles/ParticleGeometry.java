...
public abstract class ParticleGeometry extends Geometry {
    ...
    protected boolean transformParticles;
 ...
 public void addController(Controller c) {
    ...
    /**
     * Sets the alpha falloff rate over distance from the camera.  If non-zero,
     * particles' alpha values will decrease exponentially as their distance
     * from the camera increases.
     *
     * @param falloff
     *            float The alpha falloff rate.
     */
     ...
     *
     * @param frustum
     *             The new frustum area.
     */
    public void setGeometry(Frustum frustum) {
        psFrustum = frustum;
        emitType = ET_FRUSTUM;
    }
    ...
    public void initParticleLocation(int index) {
        ...
        if (particleType == PT_GEOMBATCH) {
            ...
            for (int x = 0; x < 3; x++) {
                ...
                psBatch.getParentGeom().getWorldRotation().multLocal(vertices[x]);
                vertices[x].multLocal(psBatch.getParentGeom().getWorldScale());
                vertices[x].multLocal(getInvScale());
                t.set(x, vertices[x]);
            }
    ...
    public boolean isTransformParticles() {
        return transformParticles;
    }
 ...
 public void write(JMEExporter e) throws IOException {
        ...
        capsule.write(psFrustum, "psFrustum", null);
        ...
        capsule.write(alphaFalloff, "alphaFalloff", 0f);
        ...
        capsule.write(transformParticles, "transformParticles", false);
 ...
 public void read(JMEImporter e) throws IOException {
        ...
        psFrustum = (Frustum)capsule.readSavable("psFrustum", null);
        ...
        alphaFalloff = capsule.readFloat("alphaFalloff", 0f);
